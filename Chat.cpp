...
Chat::Server::_iceD_FindUser(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->readAll(iceP_name);
    inS.endReadParams();
    ::std::shared_ptr<UserPrx> ret = this->FindUser(::std::move(iceP_name), current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    inS.endWriteParams();
    return true;
...
Chat::Server::_iceD_RegisterUser(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    ::std::shared_ptr<UserPrx> iceP_name;
    istr->readAll(iceP_name);
    inS.endReadParams();
...
/// \cond INTERNAL
void
Chat::UserPrx::_iceI_SendMessage(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::string& iceP_roomName, const ::std::shared_ptr<UserPrx>& iceP_who, const ::std::string& iceP_message, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Chat::ServerPrx::_iceI_FindUser(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::shared_ptr<UserPrx>>>& outAsync, const ::std::string& iceP_name, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Chat::ServerPrx::_iceI_RegisterUser(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_name, const ::Ice::Context& context)
{
...
/// \cond INTERNAL
void
Chat::ServerPrx::_iceI_removeUser(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::shared_ptr<UserPrx>& iceP_name, const ::Ice::Context& context)
{
...
Chat::NoSuchUserExists::_writeImpl(::Ice::OutputStream* ostr) const
{
    ...
    ::Ice::StreamWriter< NoSuchUserExists, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< NoSuchUserExists, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
Chat::NoSuchRoomExists::_writeImpl(::Ice::OutputStream* ostr) const
{
    ...
    ::Ice::StreamWriter< NoSuchRoomExists, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}
...
{
    istr->startSlice();
    ::Ice::StreamReader< NoSuchRoomExists, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}
/// \endcond
...
Chat::Server::_iceD_FindUser(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    ...
    istr->read(iceP_name);
    inS.endReadParams();
    UserPrx ret = this->FindUser(iceP_name, current);
    ::Ice::OutputStream* ostr = inS.startWriteParams();
    ostr->write(ret);
    inS.endWriteParams();
    return true;
